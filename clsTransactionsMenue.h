...
private:
    enum enTransactionsMenueOptions {
        ...
        eShowTotalBalance = 3,
        eTransfer = 4, eTransferLogScreen = 5, eShowMainMenue = 6
    };

    static short ReadTransactionsMenueOption()
    {
        cout << setw(37) << left << "" << "Choose what do you want to do? [1 to 6]? ";
        short Choice = clsInputValidate::ReadNumberBetween<short>("Enter Number between 1 to 6: ",1, 6 );
        return Choice;
    }
    ...
    static void _ShowTranserScreen()
    {
